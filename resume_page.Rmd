...
-   <i class="fa brands fa-linkedin"></i> [linkedin.com/in/matiasyp/](https://linkedin.com/in/matiasyp/){target="_blank"}
-   <i class="fa fa-phone"></i> +56 966020096


## Disclaimer {#disclaimer}

Este resumen fue desarrollado con el paquete de R [**pagedown**](https://github.com/rstudio/pagedown){target="_blank"}.
